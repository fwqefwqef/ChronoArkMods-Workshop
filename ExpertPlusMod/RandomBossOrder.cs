...
namespace ExpertPlusMod
{
    public class RandomBossOrder
    {
        ...
        class RandomizeQueues_Patch
        {
            ...
            static bool Prefix()
            {
                //Debug.Log("Randomizing boss queues");
                List<string> queuesToRandomize = new List<string> {
                    ...
                    //GDEItemKeys.EnemyQueue_Shiranui_Queue,
                    GDEItemKeys.EnemyQueue_Casino_Queue,
                    //GDEItemKeys.EnemyQueue_Queue_FanaticBoss
                    };

                if (queuesToRandomize.Contains(PlayData.BattleQueue))
                {
                    Debug.Log("Contains Battleq");
