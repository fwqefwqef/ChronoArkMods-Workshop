...
{
    public static class ExpertPlusBossPlugin
    {
        // Modify gdata.json
        ...
        class ModifyGData
        {
            ...
            static void Prefix(ref string dataString)
            {
                if (!_logged)
                {
                    Debug.Log("[ExpertPlusMod] BossChanges ModifyGData InitFromText prefix active");
                    _logged = true;
                }
                ...
                foreach (var e in masterJson)
                {
                    ...
                    if (((Dictionary<string, object>)e.Value).ContainsKey("_gdeSchema"))
                    {
                        ...
                        // Sir Dorchi Swords: Cast extended heal
                    ...
                    //SirDorchi: CC and Bleed accuracy +10 %
                        ...
                        // Ultimate Fantasy: Now an AoE Attack that applies Tumbledochi's debuff
                        if (e.Key == "S_LBossFirst_4")
                        {
                            (masterJson[e.Key] as Dictionary<string, object>)["Target"] = "all_enemy";
                            (masterJson[e.Key] as Dictionary<string, object>)["Particle"] = "Particle/Enemy/Wilderness/Tumbledochi";
                            (masterJson[e.Key] as Dictionary<string, object>)["Effect_Target"] = "SE_Tumbledochi_T";
                        }
                        ...
                        if (e.Key == "LBossFirst_Summons_1")
                        {
                            ...
                            a.Add("S_Public_15");
                            (masterJson[e.Key] as Dictionary<string, object>)["Skills"] = a;
                            (masterJson[e.Key] as Dictionary<string, object>)["reg"] = 33;
                            (masterJson[e.Key] as Dictionary<string, object>)["def"] = 45;
                        }
        ...
        static System.Collections.IEnumerator WindyTurns(B_Joker_P_0 __instance)
        {
            ...
            {
                yield return BattleText.InstBattleText_Co(__instance.BChar, ScriptLocalization.CharText_Enemy_Joker.Talk_0, false, 0, 0f, false);
                yield return BattleText.InstBattleText_Co(__instance.BChar, ScriptLocalization.CharText_Enemy_Joker.Talk_1, false, 0, 0f, false);
                yield return BattleText.InstBattleText_Co(__instance.BChar, ScriptLocalization.CharText_Enemy_Joker.Talk_2, false, 0, 0f, false);
            }
            else if (BattleSystem.instance.TurnNum == 3)
            {
                yield return BattleText.InstBattleText_Co(__instance.BChar, ScriptLocalization.CharText_Enemy_Joker.Talk_4, false, 0, 0f, false);
            }
        ...
        class JokerPatch
        {
            ...
            static bool Prefix2(B_Joker_P_0 __instance, SkillButton Mybutton)
            {
                ...
                if (BattleSystem.instance.TurnNum == 1)
                {
                    BattleSystem.DelayInput(BattleText.InstBattleText_Co(__instance.BChar, ScriptLocalization.CharText_Enemy_Joker.Talk_3, false, 0, 0f, false));
                }
                return false;
            }
        }
